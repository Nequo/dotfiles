...
;;
(defgroup doom-frostbite-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom doom-frostbite-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-frostbite-theme
  :type 'boolean)

(defcustom doom-frostbite-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-frostbite-theme
  :type 'boolean)

(defcustom doom-frostbite-comment-bg doom-frostbite-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-frostbite-theme
  :type 'boolean)

(defcustom doom-frostbite-padded-modeline doom-themes-padded-modeline
...
(eval-and-compile
  (defcustom doom-frostbite-region-highlight t
...
(def-doom-theme frostbite
  ...
  ((bg         '("#2E3440" nil       nil            ))
   ...
   (selection      dark-blue)
   (builtin        teal)
   (comments       (if doom-frostbite-brighter-comments dark-cyan (doom-lighten base5 0.2)))
   (doc-comments   (doom-lighten (if doom-frostbite-brighter-comments dark-cyan base5) 0.25))
   (constants      magenta)
   (functions      teal)
   (keywords       blue)
   (methods        teal)
   ...
   (numbers        magenta)
   (region         (pcase doom-frostbite-region-highlight
                     (`frost teal)
                     (`snowstorm base7)
                     (_ base4)))
   (error          red)
   ...
   (-modeline-bright doom-frostbite-brighter-modeline)
   (-modeline-pad
    (when doom-frostbite-padded-modeline
      (if (integerp doom-frostbite-padded-modeline) doom-frostbite-padded-modeline 4)))

   (region-fg
    (when (memq doom-frostbite-region-highlight '(frost snowstorm))
      bg-alt))
  ...
  (((region &override) :foreground region-fg)
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if doom-frostbite-comment-bg (doom-lighten bg 0.05)))
   (font-lock-doc-face
   ...
   (org-level-1          :foreground blue :weight 'bold :height 1.45)
   (org-level-2          :foreground blue :weight 'bold :height 1.25)
   (org-level-3          :foreground blue :bold bold :height 1.15)
   (org-level-4          :foreground blue :bold bold :height 1.15)
...
(after! org
  ...
  (setq
   ...
   '(("TODO" :foreground "#ebcb8b" :weight normal :underline t)
     ("WAITING" :foreground "#d08770" :weight normal :underline t)
     ("INPROGRESS" :foreground "#b48ead" :weight normal :underline t)
     ("DONE" :foreground "#a3be8c" :weight normal :underline t)
     ("CANCELLED" :foreground "#bf616a" :weight normal :underline t))
   ))
;;; frostbite-theme.el ends here
