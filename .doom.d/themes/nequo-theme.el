...
(defgroup nequo-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(def-doom-theme nequo
  ...
  ((font-lock-comment-face
   ...
   (company-tooltip-common :foreground dark-blue)
   (org-block            :background base1)
   (org-level-1          :foreground base8 :weight 'bold :height 1.4)
   (org-level-2          :foreground base6 :weight 'bold :height 1.3)
   (org-level-3          :foreground base5 :bold bold :height 1.2)
   (org-level-4          :foreground base4 :bold bold :height 1.2)
