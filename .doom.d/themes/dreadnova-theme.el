;;; dreadnova-theme.el --- Inspired by VSCode Horizon -*- no-byte-compile: t; -*-
...
;;; Code:
(defgroup dreadnova-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom dreadnova-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'dreadnova-theme
  :type 'boolean)

(defcustom dreadnova-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'dreadnova-theme
  :type 'boolean)

(defcustom dreadnova-comment-bg dreadnova-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their legibility."
  :group 'dreadnova-theme
  :type 'boolean)

(defcustom dreadnova-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to determine the exact padding."
  :group 'dreadnova-theme
  :type '(choice integer boolean))

;;
(def-doom-theme dreadnova
  ...
  ( (bg         '("#232530" "#232530" nil            ))
    ...
    (violet     '("#D86EEB" "#b877db" "brightmagenta"))
    ...
    (-modeline-bright dreadnova-brighter-modeline)
    (-modeline-pad
      (when dreadnova-padded-modeline
        (if (integerp dreadnova-padded-modeline) dreadnova-padded-modeline 4)))
  ...
  ( (elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
    ...
    (font-lock-comment-face
      :inherit 'italic
      :foreground comments
      :background (if dreadnova-comment-bg (doom-lighten bg 0.05)))
    (font-lock-doc-face
    ...
    (org-headline-done :foreground base4 :weight 'normal :strike-through t)
    (org-level-1          :foreground base6 :weight 'normal :height 1.45)
    (org-level-2          :foreground base6 :weight 'normal :height 1.25)
    (org-level-3          :foreground base6 :weight 'normal :height 1.15)
    (org-level-4          :foreground base6 :weight 'normal :height 1.15)
    ...
    ;; company
    (company-box-background    :background red :foreground fg)
...
(after! org
  (setq
   ...
   '(("TODO" :foreground "#21bfc2" :weight normal :underline t)
     ("WAITING" :foreground "#fab795" :weight normal :underline t)
     ("INPROGRESS" :foreground "#b877db" :weight normal :underline t)
     ("DONE" :foreground "#09f7a0" :weight normal :underline t)
     ("CANCELLED" :foreground "#eC6a88" :weight normal :underline t))
   ))

;;; dreadnova-theme.el ends here
